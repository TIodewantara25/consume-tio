...
const handleLogin = (event) => {
    ...
    .then(res => {
        ...
        navigate('/Profile')
        //setitem() => nambah key di localstorage
        //getitem() => mengambil key di localstorage
        //removeitem() => hapus key di localstorage
                ...
                <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
                    <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                            ...
                            {/* ternry untuk mengece apakah state error memiliki data, jika iya muncul datanya dengan looping */}
                            {
                                Object.keys(error).length > 0 ? (
                                    <div role= "alert">
                                        <div class="bg-red-500 text-with font-bold rounded-t px-4 py-2">
                                            Gagal!
                                        </div>
